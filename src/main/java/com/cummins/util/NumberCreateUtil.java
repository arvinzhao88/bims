...
public class NumberCreateUtil {
	...
	public NumberCreateUtil() {
		// TODO Auto-generated constructor stub
	}
	
	public static String createId(String maxOrderno){
		String Orderno = null;
        //String maxOrderno = "GD201801170011"; // 从数据库查询出的最大编号
        //System.out.println("maxOrderno=" + maxOrderno);
        SimpleDateFormat format = new SimpleDateFormat("yyyyMMdd"); // 时间字符串产生方式
        String uid_pfix = "BJ" + format.format(new Date()); // 组合流水号前一部分，NO+时间字符串，如：NO20160126
