...
public class Issue implements Serializable {
    ...
    public String toString() {
        return "Issue{" +
                ...
                ", issueCategoryL1Name='" + issueCategoryL1Name + '\'' +
                ", issueCategoryL1='" + issueCategoryL1 + '\'' +
                ", issueCategoryL2Name='" + issueCategoryL2Name + '\'' +
                ", issueCategoryL2='" + issueCategoryL2 + '\'' +
                ", issueCategoryL3Name='" + issueCategoryL3Name + '\'' +
                ", issueCategoryL3='" + issueCategoryL3 + '\'' +
                ...
                ", isCarry='" + isCarry + '\'' +
                ", isClaim='" + isClaim + '\'' +
                ", isCountindex='" + isCountindex + '\'' +
                ", inputTime=" + inputTime +
                ", inputPerson='" + inputPerson + '\'' +
                ", inputPresonName='" + inputPresonName + '\'' +
                ", inputPersonAccount='" + inputPersonAccount + '\'' +
                ", delflag='" + delflag + '\'' +
                ", subSource='" + subSource + '\'' +
                ", processStatus='" + processStatus + '\'' +
                ", processPerson='" + processPerson + '\'' +
                ", processPersonName='" + processPersonName + '\'' +
                ", processPersonAccount='" + processPersonAccount + '\'' +
                ", processTime=" + processTime +
                ", processMethod='" + processMethod + '\'' +
                ", reviewPerson='" + reviewPerson + '\'' +
                ", reviewPersonName='" + reviewPersonName + '\'' +
                ", reviewPersonAccount='" + reviewPersonAccount + '\'' +
                ", reviewTime=" + reviewTime +
                ", closeTime=" + closeTime +
                ", attach='" + attach + '\'' +
                ", issueExtend='" + issueExtend + '\'' +
                '}';
    }
}