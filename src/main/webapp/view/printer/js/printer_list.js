...
printer.url = ctx;
printer.requestUrl = {
    queryList: printer.url + "/printer/pageList"
};
...
printer.filed = [
    ...
    {
        "data": "personAccount", // 工号
    },
    {
        "data": "personName", // 姓名
    },
    {
        "data": "printerIp", // 打印机IP
    },
    {
    ...
    },
    {
        ...
        "createdCell": function (nTd, sData, oData, iRow, iCol) {
            var html = '<a href="#" onclick="edit(\'' + oData.personAccount + '\')" data-target=".this-true"><i class="fa fa-edit"></i> 编辑</a><br>' +
                '<a href="#" onclick="remove(\'' + oData.id + '\')" data-target=".this-true"><i class="fa fa-trash"></i> 删除</a>';
            $(nTd).html(html);
        }
    }
];
...
// 编辑信息
function edit(acc) {
    window.location.href = ctx + '/printer/toBindPrinter?account=' + acc;
}
