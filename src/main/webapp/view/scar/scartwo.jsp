                            ...
                            <form id="form1" name="form1" method="post">
                                ...
                                <table width="100%" class=" table table-hover table-bordered" >
                                    ...
                                    <tr><td colspan="4">
                                        <div class="form-group" style="font-size:14px;border-bottom:1px #F2F2F2 dashed;">
                                            ...
                                            <textarea  style="float:left"  id="text1" name="sevenstepDesc" rows="2" class="form-control" id="message" required="required" data-parsley-trigger="keyup" data-parsley-minlength="20" data-parsley-maxlength="100">${toolsSevenSteps.sevenstepDesc}</textarea>
                                        </div>
                                        <div class="form-group" style="font-size:14px;border-bottom:1px #F2F2F2 dashed;">
                                    ...
                                    <tr>
                                        <td colspan="4">
                                            ...
                                            <button id="yyzz" type="button" class="btn btn-default btn-sm" onclick="$('#YYZZFBSMJ').click();">
                                                上传附件
                                            </button><input type="hidden"  name="attmentTwo" id="setp2file" >
                                            ...
                                            <c:if test="${not empty toolsSevenSteps.attmentTwo}">
                                                <a href="${uploadUrl}${toolsSevenSteps.attmentTwo}" download target="_blank">下载驳回附件</a>
                                            </c:if>
                                        </td>
                                ...
                                <div class="form-group">
                                    <div style="text-align:center;">
                                        ...
                                        <button class="btn btn-primary" type="button" onclick="submitData()"   data-toggle="modal"<%-- data-target=".this-go"--%>>下一步</button>
                                    </div>
                                </div>
                                            ...
                                            <table width="100%" class=" table table-hover table-bordered" id="datatable1">
                                                ...
                                                <tr><td colspan="4">
                                                    <div class="form-group" style="font-size:14px;border-bottom:1px #F2F2F2 dashed;">
                                                        <p style="text-align: left;font-size: 15px"><span style="border-radius:30%;color:#FFFFFF;background-color:#009688;padding:2px;">&nbsp;1&nbsp;</span>&nbsp;
                                                        Identify the problem.识别问题(5W2H).</p>
                                                        <textarea  style="float:left"  name="sevenstepDesc" rows="2" class="form-control" id="message" required="required" data-parsley-trigger="keyup" data-parsley-minlength="20" data-parsley-maxlength="100">${toolsSevenSteps.sevenstepDesc}</textarea>
                                                    </div>
                                                    <div class="form-group" style="font-size:14px;border-bottom:1px #F2F2F2 dashed;">
                                                        <p style="text-align: left;font-size: 15px">  <span style="border-radius:30%;color:#FFFFFF;background-color:#009688;padding:2px;">&nbsp;2&nbsp;</span>&nbsp;
                                                        Identify and Rank Assignable Causes.识别和排列必然原因 (FTA, Fishbone, Pareto)。</p>
                                                ...
                                                <tr>
                                                    <td colspan="4">
                                                        ...
                                                        <button id="yyzz" type="button" class="btn btn-default btn-sm" onclick="$('#YYZZFBSMJ').click();">
                                                            上传附件
                                                        </button><input type="text"  name="attmentTwo" id="setp2file" style="display: none;">
                                                        <input type="file" name="YYZZFBSMJ" id="YYZZFBSMJ" style="display: none;" onchange="fileType()">
                                                        <p id="fileName" ></p >
                                                    </td>
                                                <tr><td width="20%">Target Date 目标日期</td>
    ...
    function  submitData() {
      ...
      /*  var setp2file=  $("#setp2file").val();
        ...
        layer.confirm('确定提交给审核人审核吗？', {
            ...
            $.ajax({
                url: "${resPath}/Scar/updatesevensteptwo",
                type: "post",
                data: $('#form1').serialize(),
                success: function (data) {
                    console.log(data)
                    window.location.href="${webPath}/Scar/showSevenSteptwo/"+data.obj;
