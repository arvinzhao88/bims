...
<div class="container body">
                        ...
                        <form id="form1" name="form1" method="post">
                            ...
                            <div role="tabpanel" class="tab-pane fade active in" id="tab_content13" aria-labelledby="home-tab">
                                <table width="100%" class="table table-hover table-bordered" id="" style="font-size:12px;">
                                    ...
                                    <tr>
                                        <td colspan="4">
                                            <textarea  style="float:left"    disabled ="disabled" name="sevenstepDesc" rows="2" class="form-control" id="message" required="required" data-parsley-trigger="keyup" data-parsley-minlength="20" data-parsley-maxlength="100">${toolsSevenSteps.sevenstepDesc}</textarea>
                                        </td>
                                    <tr><td width="20%">Target Date 目标日期</td>
                                        <td width="30%"></i> <fmt:formatDate value="${toolsSevenSteps.targetdate1}" pattern="yyyy-MM-dd"/></td>
                            ...
                            <div role="tabpanel" class="tab-pane fade active in" id="tab_content12" aria-labelledby="home-tab">
                                ...
                                <div class="form-group">
                                    <div style="text-align:center;">
                                      &lt;%&ndash;  <button class="btn btn-danger" type="reset" data-toggle="modal"
    ...
    <%--<div class="main_container">
        ...
        <!-- 内容区开始 -->
       &lt;%&ndash; <div class="right_col" role="main">
...
<script>
    function  submitData() {
        ...
        $.ajax({
            url: "${resPath}/toolsSevenSteps/updatesevenstep",
            type: "post",
