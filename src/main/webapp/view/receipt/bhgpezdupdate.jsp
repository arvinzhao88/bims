...
<table border="0" align="center" cellpadding="0" cellspacing="2" class="tab">
    ...
    <tr>
        <td>Issue Description<br />
            问题描述：</td>
        <td colspan="5"><textarea name="issueDescription" rows="2" style="width:98%;border:0;border-bottom:1px solid #000;background:#fff; line-height:18px;" placeholder="">${nonconfigContainment.issueDescription}</textarea></td>
    </tr>
    <tr>
        <td>Spec<br>标准或要求：</td>
        <td colspan="4"><input type="text" name="spec" class="input_0"  value="${nonconfigContainment.spec}"/></td>
        <td>是否需要WI：
            <input type="radio" name="wi" value="1"  class="input" <c:if test="${fn:contains(nonconfigContainment.wi,1)}">checked="checked"</c:if> />
            是YES&nbsp;
            <input type="radio" name="wi" value="2" class="input" <c:if test="${fn:contains(nonconfigContainment.wi,2)}">checked="checked"</c:if> />
            否NO</td>
    </tr>
</table>
...
<table border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#000000" class="tab">
    ...
    <c:if test="${empty customerArea}">
        <tr>
            ...
            <td width="8%" align="center"><input type="text" name="qtty" class="input_f"  value=""/></td>
            <td width="12%" align="center"><input type="text" name="screendQtty" class="input_f"  value=""/></td>
            <td width="10%" align="center"><input type="text" name="nokQtty" class="input_f"  value=""/></td>
            <td width="13%" align="center"><input type="text" name="response" class="input_f"  value=""/></td>
            <td width="13%" align="center"><input type="text" name="verifier" class="input_f"  value=""/></td>
            <td width="18%" align="center"><input type="text" name="completionDate" class="input_f"  value=""/></td>
        </tr>
        <tr>
            <td align="center">Engine in OEM process<br />
                客户生产过程中的发动机<input type="hidden" name="location" class="input_f"  value="2"/> </td></td>
            <td width="8%" align="center"><input type="text" name="qtty" class="input_f"  value=""/></td>
            <td width="12%" align="center"><input type="text" name="screendQtty" class="input_f"  value=""/></td>
            <td width="10%" align="center"><input type="text" name="nokQtty" class="input_f"  value=""/></td>
            <td width="13%" align="center"><input type="text" name="response" class="input_f"  value=""/></td>
        ...
        <tr>
            <td align="center">Engine in OEM EOL Stock<br />
                客户成品库的发动机<input type="hidden" name="location" class="input_f"  value="3"/> </td>
            <td width="8%" align="center"><input type="text" name="qtty" class="input_f"  value=""/></td>
            <td width="12%" align="center"><input type="text" name="screendQtty" class="input_f"  value=""/></td>
            <td width="10%" align="center"><input type="text" name="nokQtty" class="input_f"  value=""/></td>
            <td width="13%" align="center"><input type="text" name="response" class="input_f"  value=""/></td>
        ...
        <tr>
            <td align="center">Engine on Vehicle out of OEM<br />
                随车出厂的发动机<input type="hidden" name="location" class="input_f"  value="4"/></td>
            <td width="8%" align="center"><input type="text" name="qtty" class="input_f"  value=""/></td>
            <td width="12%" align="center"><input type="text" name="screendQtty" class="input_f"  value=""/></td>
            <td width="10%" align="center"><input type="text" name="nokQtty" class="input_f"  value=""/></td>
            <td width="13%" align="center"><input type="text" name="response" class="input_f"  value=""/></td>
        ...
        <tr>
            <td align="center">Others 其他 <input type="hidden" name="location" class="input_f"  value="5"/></td>
            <td width="8%" align="center"><input type="text" name="qtty" class="input_f"  value=""/></td>
            <td width="12%" align="center"><input type="text" name="screendQtty" class="input_f"  value=""/></td>
            <td width="10%" align="center"><input type="text" name="nokQtty" class="input_f"  value=""/></td>
            <td width="13%" align="center"><input type="text" name="response" class="input_f"  value=""/></td>
    ...
    <tr>
        <c:if test="${customer.location=='1'}">
            <td align="center">Engine In OEM stock<br />客户库存发动机<input type="hidden" name="location" class="input_f"  value="1"/></td>
        </c:if>
        <c:if test="${customer.location=='2'}">
            <td align="center">Engine in OEM process<br />客户生产过程中的发动机<input type="hidden" name="location" class="input_f"  value="2"/></td>
        </c:if>
        <c:if test="${customer.location=='3'}">
            <td align="center">Engine in OEM EOL Stock<br />客户成品库的发动机<input type="hidden" name="location" class="input_f"  value="3"/> </td>
        </c:if>
        <c:if test="${customer.location=='4'}">
            <td align="center">Engine on Vehicle out of OEM<br />随车出厂的发动机<input type="hidden" name="location" class="input_f"  value="4"/></td>
        </c:if>
        <c:if test="${customer.location=='5'}">
            <td align="center">Others 其他 <input type="hidden" name="location" class="input_f"  value="5"/></td>
        </c:if>
            <td width="8%" align="center"><input type="text" name="qtty" class="input_f"  value="${customer.qtty}"/></td>
            <td width="12%" align="center"><input type="text" name="screendQtty" class="input_f"  value="${customer.screendQtty}"/></td>
            <td width="10%" align="center"><input type="text" name="nokQtty" class="input_f"  value="${customer.nokQtty}"/></td>
            <td width="13%" align="center"><input type="text" name="response" class="input_f"  value="${customer.response}"/></td>
            <td width="13%" align="center"><input type="text" name="verifier" class="input_f"  value="${customer.verifier}"/></td>
            <td width="18%" align="center"><input type="text" name="completionDate" class="input_f"  value="${customer.completionDate}"/></td>
    </tr>
        </c:forEach>
    </c:if>
...
<table border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#000000" class="tab">
    ...
    <c:if test="${empty bfcec}">
        <tr>
            <td width="26%" align="center">Inventory Parts<br />
                库存零件 <input type="hidden" name="location" class="input_f"  value="6"/></td>
            <td width="8%" align="center"><input type="text" name="qtty" class="input_f"  value=""/></td>
            <td width="12%" align="center"><input type="text" name="screendQtty" class="input_f"  value=""/></td>
            <td width="10%" align="center"><input type="text" name="nokQtty" class="input_f"  value=""/></td>
            <td width="13%" align="center"><input type="text" name="response" class="input_f"  value=""/></td>
        ...
        <tr>
            <td align="center">Pending storage<br />
                待入库(HOLD库 外检待入）<input type="hidden" name="location" class="input_f"  value="7"/></td>
            <td width="8%" align="center"><input type="text" name="qtty" class="input_f"  value=""/></td>
            <td width="12%" align="center"><input type="text" name="screendQtty" class="input_f"  value=""/></td>
            <td width="10%" align="center"><input type="text" name="nokQtty" class="input_f"  value=""/></td>
            <td width="13%" align="center"><input type="text" name="response" class="input_f"  value=""/></td>
   ...
   <c:if test="${!empty bfcec}">
        ...
        <tr>
            ...
            <td width="8%" align="center"><input type="text" name="qtty" class="input_f"  value="${bfce.qtty}"/></td>
            <td width="12%" align="center"><input type="text" name="screendQtty" class="input_f"  value="${bfce.screendQtty}"/></td>
            <td width="10%" align="center"><input type="text" name="nokQtty" class="input_f"  value="${bfce.nokQtty}"/></td>
            <td width="13%" align="center"><input type="text" name="response" class="input_f"  value="${bfce.response}"/></td>
            <td width="13%" align="center"><input type="text" name="verifier" class="input_f"  value="${bfce.verifier}"/></td>
            <td width="18%" align="center"><input type="text" name="completionDate" class="input_f"  value="${bfce.completionDate}"/></td>
        </tr>
        </c:forEach>
    </c:if>
    ...
    <c:if test="${!empty supplierArea}">
        <c:forEach items="${supplierArea}" var="supp">
            <tr>
                ...
                <td width="8%" align="center"><input type="text" name="qtty" class="input_f"  value="${supp.qtty}"/></td>
                <td width="12%" align="center"><input type="text" name="screendQtty" class="input_f"  value="${supp.screendQtty}"/></td>
                <td width="10%" align="center"><input type="text" name="nokQtty" class="input_f"  value="${supp.nokQtty}"/></td>
                <td width="13%" align="center"><input type="text" name="response" class="input_f"  value="${supp.response}"/></td>
                <td width="13%" align="center"><input type="text" name="verifier" class="input_f"  value="${supp.verifier}"/></td>
                <td width="18%" align="center"><input type="text" name="completionDate" class="input_f"  value="${supp.completionDate}"/></td>
            </tr>
...
<table width="650" border="0" align="center" cellpadding="0" cellspacing="0">
    <tr>
        <td height="50" align="center" bgcolor="#F6F6F6"><input type="button" name="print2" value="保存" onclick="savetData()" /></td>
        <td height="50" align="center" bgcolor="#F6F6F6"><input type="button" name="print2" value="提交" onclick="submitData()" /></td>
...
<script language="javascript">
    ...
    function  savetData() {
        if (${nonconfigContainment.statue==2}){
        ...
        $.ajax({
            url: "${webPath}/NonProductContainment/queryNonconformingProductContainmentOrder",
            type: "post",
    ...
    function  submitData() {
        ...
        console.log($('#form1').serialize());
        $.ajax({
            url: "${webPath}/NonProductContainment/saveTheNonconformingProductContainmentOrder",
            type: "post",
            data: $('#form1').serialize(),
            success: function (data) {
                layer.msg("提交成功");
