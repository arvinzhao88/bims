...
<form id="form1" name="form1" method="post">
            ...
            <td height="50" valign="top" width="calc(100% - 200px)" style=" border-bottom:#000000 2px dashed;">
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                        ...
                        <td width="25%">
                            <input type="radio" name="inPlantCustomers2" value="1"
                    ...
                    <tr>
                        <td>
                                <input type="radio" name="inPlantCustomers2" value="2"  class="input"  <c:if test="${fn:contains(documentsToBeProcesses.inPlantCustomers2,'2')}">checked="checked"
                                </c:if>/> Customer
                                客户
                        </td>
    ...
    <table class="tab" align="center" border="0" cellspacing="2" cellpadding="0">
        <tr>
            ...
            <td width="30%">BFCEC&nbsp;
                <input type="radio" name="back4" value="1" class="input"  <c:if test="${fn:contains(documentsToBeProcesses.back4,'1')}">checked="checked"
                </c:if> />
                &nbsp;&nbsp;Supplier供应商&nbsp;
                <input type="radio" name="back4" value="2" class="input"  <c:if test="${fn:contains(documentsToBeProcesses.back4,'2')}">checked="checked"
                </c:if> /></td>
                ...
                <table width="100%" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                        ...
                        <td style="border-right:#000000 2px dashed;">&nbsp;By Line Parts<br>
                            &nbsp;线旁零件&nbsp;&nbsp;&nbsp;&nbsp;
                            <input type="checkbox" name="holdScope" value="1" class="input"
                        ...
                        <td style="border-right:#000000 2px dashed;">&nbsp;Stock Parts<br>&nbsp;库存零件&nbsp;&nbsp;&nbsp;&nbsp;<input
                                type="checkbox" name="holdScope" value="2" class="input"
                        ...
                        <td style="border-right:#000000 2px dashed;">&nbsp;Work In Process<br>&nbsp;在制发动机&nbsp;&nbsp;&nbsp;&nbsp;<input
                                type="checkbox" name="holdScope" value="3" class="input"
                        ...
                        <td style="border-right:#000000 2px dashed;">&nbsp;Finished Product<br>&nbsp;成品发动机&nbsp;&nbsp;&nbsp;&nbsp;<input
                                type="checkbox" name="holdScope" value="4" class="input"
            ...
            <td height="65" colspan="3" valign="top" style=" border-bottom:#000000 2px dashed;">
                <table width="100%" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                        ...
                        <td width="27%"><input type="text" name="disposition" class="input_0" placeholder=""
                        ...
                        <td><input type="text" name="textfield" class="input_0" readonly="readonly"
                                   value="${documentsToBeProcesses.updateAccount}"/></td>
                        <td colspan="2">&nbsp;</td>
                    </tr>
                    <%--<tr>
                        <td height="30"><strong>Quality engineer 质量工程师：</strong></td>
...
<%--<link rel="stylesheet" type="text/css" href="${resPath}"/>--%>
<script language="javascript">
    
    function  savetData() {
       if (${documentsToBeProcesses.statue==2}){
