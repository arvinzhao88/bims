                        ...
                        <form id="form1" name="form1" method="post">
                            ...
                            <table width="100%" class="table table-hover table-bordered" >
                                ...
                                <tr><td colspan="4">
                                    ...
                                    <button id="yyzz" type="button" class="btn btn-default btn-sm" onclick="$('#YYZZFBSMJ').click();">
                                        上传附件
                                    </button><input  name="attmentThree" type="hidden"  id="setp2file" style="display: none;">
                                    <input type="file"  name="attmentThree" id="YYZZFBSMJ" style="display: none;" onchange="fileType()">
                                    <p id="fileName2" ></p >

                                    <c:if test="${not empty toolsSevenSteps.attmentThree}">
                                        <a href="${uploadUrl}${toolsSevenSteps.attmentThree}" download target="_blank">查看驳回附件</a>
                                    </c:if>
                                </td>
                                    <%--<td colspan="2">
                                        <i class="fa fa-edit" style="font-size:30px;padding:10px;vertical-align:middle;"></i>&nbsp;<button type="button" class="btn btn-default btn-sm" data-toggle="modal" data-target=".this-shenpi">处理审核</button></td>--%>
                            ...
                            <%--<table width="100%" class="table table-hover table-bordered" >
                                ...
                                <tr><td colspan="4">
                                    ...
                                    <button id="yyzz" type="button" class="btn btn-default btn-sm" onclick="$('#YYZZFBSMJ1').click();">
                                        上传附件
                                    </button><input type="hidden"  name="attmentSeven" id="setp3file" style="display: none;">
                                ...
                                &lt;%&ndash;<tr><td width="20%">Target Date 目标日期</td>
                                    <td width="30%"><i class="fa fa-history"></i> 倒计时：29天 22:15:38</td><td width="20%">Complete Date 完成日期</td><td width="30%">处理中（以完成系统时间为准）</td></tr>&ndash;%&gt;
                            </table>--%>
...
<script>
   ...
   function  submitData() {
       ...
       layer.confirm('确定提交给审核人审核吗？', {
           ...
           $.ajax({
               url: "${resPath}/toolsSevenSteps/updateToolsPersonTypefour",
               type: "post",
               data: $('#form1').serialize(),
               success: function (data) {
                   console.log(data);
                   window.location.href="${webPath}/toolsSevenSteps/showSevenStepfour/"+data.obj;
