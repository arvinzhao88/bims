                            ...
                            <table width="100%" class=" table table-hover table-bordered" >
                                <tr>
                                    <td colspan="4">
                                        ...
                                        <div style="color:#5A738E; float:right;">审核人：${sessionScope.person.name}</div>
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="4">
                                ...
                                <tr>
                                    ...
                                    <td colspan="4">
                                        ...
                                        <input type="file" name="YYZZFBSMJ" id="YYZZFBSMJ" style="display: none;"
                                               onchange="fileType()">
                                        <p id="fileName"></p>
                                    </td>
                                    </c:if>
                                ...
                                <%-- <tr><td colspan="4">
                                     ...
                                     <div class="form-group" style="font-size:14px;border-bottom:1px #F2F2F2 dashed;">
                                         <p style="text-align: left;font-size: 15px">  <span style="border-radius:30%;color:#FFFFFF;background-color:#009688;padding:2px;">&nbsp;7.1&nbsp;</span>&nbsp;
                                             Seven-step report upload 七步法报告上传。</p>
                                     </div>

                                 </td></tr>--%>
                                <tr><%--<td colspan="4">
                                &lt;%&ndash;<i class="fa fa-file-text" style="font-size:30px;padding:10px;vertical-align:middle;"></i>&nbsp;<button type="button" class="btn btn-default btn-sm">上传附件</button>&ndash;%&gt;

                                <a href="${uploadUrl}${toolsSevenSteps.attmentSeven}" >下载附件三</a>
                            ...
                            <div class="form-group">
                                <div style="text-align:center;">
                                    ...
                                    <button class="btn btn-primary" onclick="submitData()" type="button"
                                            data-toggle="modal" data-target=".this-go">下一步
                                    </button>
                                </div>
                            </div>
                    </div>
...
<script>
    ...
    function submitData() {
        ...
        layer.confirm('确定审核通过吗？', {
            ...
            $.ajax({
                url: "${resPath}/toolsSevenSteps/updateSevenStepfivenext",
                type: "post",
                data: $('#form1').serialize(),
                success: function (data) {
                    console.log(data)
        ...
        /* $.ajax({
             url: "${resPath}/7 STEP/passFourToSix",
            type: "post",
            data: $('#form1').serialize(),
            success: function (data) {
                console.log(data)
