...
<div class="container body">
    ...
    <div class="modal fade this-no" tabindex="-1" role="dialog" aria-hidden="true" >
        <div class="modal-dialog modal-lg" style="width:350px;padding-bottom:10%;">
...
<script>
    ...
    function reject() {
        ...
        $.ajax({
            url: "${resPath}/toolsSevenSteps/updatesevenstepthree",
            type: "post",
   ...
   function  submitData() {
       ...
       layer.confirm('确定审核通过吗？', {
           ...
           $.ajax({
               url: "${resPath}/toolsSevenSteps/updatesevenstepthreenext",
               type: "post",
               data: $('#form1').serialize(),
               success: function (data) {
                   console.log(data)
