            ...
            <div class="form-group">
                <div class="" role="tabpanel" data-example-id="togglable-tabs">
                    ...
                    <li role="presentation" class=""><a href="#tab_content22" role="tab"
                                                        ...
                                                        aria-expanded="false">7 STEP</a></li>--%>
                    ...
                    <div id="myTabContent2" class="tab-content">
                        ...
                        <form id="form1" name="form1" method="post">
                            ...
                            <table width="100%" class=" table table-hover table-bordered" >
                                <tr>
                                    <td colspan="4">
                                        ...
                                        <div style="color:#5A738E; float:right;">
                                            审核人：${sessionScope.person.name}</div>
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="4">
                                        <div class="form-group"
                                            ...
                                            <p style="text-align: left;font-size: 15px"><span
                                                    style="border-radius:30%;color:#FFFFFF;background-color:#009688;padding:2px;">&nbsp;1&nbsp;</span>&nbsp;
                                                Identify the problem.识别问题(5W2H).</p>
                                            <textarea style="float:left" name="sevenstepDesc" rows="2"
                                                      disabled="disabled" class="form-control" id="message"
                                                      required="required" data-parsley-trigger="keyup"
                                                      data-parsley-minlength="20"
                                                      data-parsley-maxlength="100">${toolsSevenSteps.sevenstepDesc}</textarea>
                                        </div>
                                        <div class="form-group"
                                             style="font-size:14px;border-bottom:1px #F2F2F2 dashed;">
                                            <p style="text-align: left;font-size: 15px"><span
                                                    style="border-radius:30%;color:#FFFFFF;background-color:#009688;padding:2px;">&nbsp;2&nbsp;</span>&nbsp;
                                                Identify and Rank Assignable Causes.识别和排列必然原因 (FTA, Fishbone,
                                                Pareto)。</p>
                                        </div>
                                        <div class="form-group"
                                             style="font-size:14px;border-bottom:1px #F2F2F2 dashed;">
                                            <p style="text-align: left;font-size: 15px"><span
                                                    style="border-radius:30%;color:#FFFFFF;background-color:#009688;padding:2px;">&nbsp;3&nbsp;</span>&nbsp;
                                ...
                                <tr>
                                    ...
                                    <td colspan="4">
                                        ...
                                        <input type="hidden" name="attmentThree" id="setp2file"
                                               style="display: none;">
                                        <input type="file" name="YYZZFBSMJ" id="YYZZFBSMJ"
                                               style="display: none;" onchange="fileType()">
                                        <p id="fileName"></p>
                                    </td>
                                    </c:if>
                                <tr>
                                    <td width="20%">Target Date 目标日期</td>
                                    <td width="30%"></i> <fmt:formatDate value="${toolsSevenSteps.targetdate1}"
                                ...
                                <c:if test="${ not empty toolsSevenSteps.completedate1}">
                                    <td width="30%"><fmt:formatDate value="${toolsSevenSteps.completedate1}"
                                                                    pattern="yyyy-MM-dd "/></td>
                                    </tr>
                            ...
                            <table width="100%" class="table table-hover table-bordered">
                                ...
                                <tr>
                                    <td colspan="4">
                                        <div class="form-group"
                                             style="font-size:14px;border-bottom:1px #F2F2F2 dashed;">
                                            <p style="text-align: left;font-size: 15px"><span
                                                    style="border-radius:30%;color:#FFFFFF;background-color:#009688;padding:2px;">&nbsp;4&nbsp;</span>&nbsp;
                                                Determine Assignable Cause(s).确定必然原因(FTA.Fishbone.Pareto)。</p>
                                        </div>
                                        <div class="form-group"
                                             style="font-size:14px;border-bottom:1px #F2F2F2 dashed;">
                                            <p style="text-align: left;font-size: 15px"><span
                                                    style="border-radius:30%;color:#FFFFFF;background-color:#009688;padding:2px;">&nbsp;5&nbsp;</span>&nbsp;
                                                Select and Verify the Solution.选择和验证解决方案。</p>
                                        </div>
                                        <div class="form-group"
                                             style="font-size:14px;border-bottom:1px #F2F2F2 dashed;">
                                            <p style="text-align: left;font-size: 15px"><span
                                                    style="border-radius:30%;color:#FFFFFF;background-color:#009688;padding:2px;">&nbsp;6&nbsp;</span>&nbsp;
                                ...
                                <tr>
                                    <td width="20%">Target Date 目标日期</td>
                                    <td width="30%"></i> <fmt:formatDate value="${toolsSevenSteps.targetdate2}"
                                                                         pattern="yyyy-MM-dd "/></td>
                                    <td width="20%">Complete Date 完成日期</td>
                                ...
                                <c:if test="${ not empty toolsSevenSteps.completedate2}">
                                    <td width="30%"><fmt:formatDate value="${toolsSevenSteps.completedate2}"
                                                                    pattern="yyyy-MM-dd "/></td>
                                    </tr>
                            ...
                            <table width="100%" class="table table-hover table-bordered" >
                                <tr>
                                    <td colspan="4">
                                        ...
                                        <div class="form-group"
                                             style="font-size:14px;border-bottom:1px #F2F2F2 dashed;">
                                            <p style="text-align: left;font-size: 15px"><span
                                                    style="border-radius:30%;color:#FFFFFF;background-color:#009688;padding:2px;">&nbsp;7.1&nbsp;</span>&nbsp;
                                                Seven-step report upload 七步法报告上传。&nbsp;&nbsp;&nbsp;&nbsp;<i
                                                        class="fa fa-clock-o green"></i> 截至日期：7天</p>
                                        </div>
                                ...
                                <tr>
                                    <td width="20%">Target Date 目标日期</td>
                                    <td width="30%"></i> <fmt:formatDate value="${toolsSevenSteps.targetdate3}"
                                                                         pattern="yyyy-MM-dd "/></td>
                                    <td width="20%">Complete Date 完成日期</td>
                                ...
                                <c:if test="${ not empty toolsSevenSteps.completedate3}">
                                    <td width="30%"><fmt:formatDate value="${toolsSevenSteps.completedate3}"
                                                                    pattern="yyyy-MM-dd "/></td>
                                    </tr>
                            ...
                            <table width="100%" border="0" cellpadding="0" cellspacing="0"
                                ...
                                <tr>
                                    <td colspan="4">
                                        ...
                                        <div class="form-group"
                                             style="font-size:14px;border-bottom:1px #F2F2F2 dashed;">
                                            <p style="text-align: left;font-size: 15px"><span
                                                    style="border-radius:30%;color:#FFFFFF;background-color:#009688;padding:2px;">&nbsp;7.2&nbsp;</span>&nbsp;
                                ...
                                <tr>
                                    ...
                                    <td colspan="4">
                                        <input type="checkbox" class="flat" name="checkFile"
                                               id="genderM" value="1" required/>&nbsp;PFMEA&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                        <input type="checkbox" class="flat" name="checkFile"
                                               id="genderM2" value="2"/>&nbsp;CP &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                        <input type="checkbox" class="flat" name="checkFile"
                                ...
                                <tr>
                                    ...
                                    <td><input type="text"
                                               required="required" class="form-control" name="esnFrom" id="id1"
                                               placeholder="手工输入"></td>
                                    <td width="5%" align="right">TO：</td>
                                    <td><input type="text"
                                               required="required" class="form-control" name="to1" id="id2"
                                               placeholder="手工输入"></td>
                                    <td width="10%" align="right">NCM QTY：</td>
                                    <td align="right"><input type="text" name="numQty" id="id3"
                                                             required="required"
                                                             class="form-control"
                                                             placeholder="手工输入"></td>
                                </tr>
                                <tr>
                                    ...
                                    <td><input type="text" name="datefrom" id="id4"
                                               required="required" class="form-control"
                                               placeholder="手工输入"></td>
                                    <td align="right">TO：</td>
                                    <td><input type="text" name="to2" id="id5"
                                               required="required" class="form-control"
                                               placeholder="手工输入"></td>
                                    <td align="right">NCM QTY：</td>
                                    <td align="right"><input type="text" name="numQty2" id="id6"
                                                             required="required"
                                                             class="form-control"
                                                             placeholder="手工输入"></td>
                                </tr>
                                <tr>
                                    ...
                                    <td colspan="4"><input type="text" name="mqv" id="id7"
                                                           required="required"
                                                           class="form-control"
                                                           placeholder="手工输入"></td>
                                </tr>
                            ...
                            <div class="form-group">
                                <div style="text-align:center;">
                                    ...
                                    <button class="btn btn-primary" onclick="submitData()" type="button"
                                            data-toggle="modal" data-target=".this-go">审核完成
                                    </button>
                                </div>
                            </div>
                    </div>
        ...
        <div class="modal-dialog modal-lg" style="width:350px;padding-top:200px;">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>请输入驳回原因：</p>
                    <textarea name="back4" rows="4" class="form-control" required="required"
                              data-parsley-trigger="keyup" data-parsley-minlength="20"
                              data-parsley-maxlength="100" placeholder="请输入"></textarea>
                </div>
...
<script>
    ...
    function submitData() {
        ...
        var id4 = $("#id4").val();
        if (id4 == "" || id4 == null || id4 == undefined) {
            layer.msg("数据请填写完整");
            return false;
        }
        var id5 = $("#id5").val();
        if (id5 == "" || id5 == null || id5 == undefined) {
            layer.msg("数据请填写完整");
            return false;
        }
        var id6 = $("#id6").val();
        if (id6 == "" || id6 == null || id6 == undefined) {
            layer.msg("数据请填写完整");
            return false;
        }
        var id7 = $("#id7").val();
        if (id7 == "" || id7 == null || id7 == undefined) {
            layer.msg("数据请填写完整");
            return false;
        }
        ...
        layer.confirm('确定审核通过吗？', {
            ...
            $.ajax({
                ...
                success: function (data) {
                    window.location.href = "${webPath}/toolsSevenSteps/jumpAll/" + data.obj;
                }
            });
        }, function(){
        });
        ...
        /*$.ajax({
            url: "${resPath}/7 STEP/jumpSevenStepsixupdate",
            type: "post",
            data: $('#form1').serialize(),
            success: function (data) {
                window.location.href = "${webPath}/7 STEP/jumpAll/" + data.obj;
            }
        });*/
    }
