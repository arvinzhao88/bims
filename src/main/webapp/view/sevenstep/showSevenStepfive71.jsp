...
<div class="container body"> <div class="x_panel" style="width:100%;float:left; margin-right:10px;">
    <%--<div class="x_title">
            ...
            <div class="" role="tabpanel" data-example-id="togglable-tabs">
                ...
                <div id="myTabContent2" class="tab-content">
                    ...
                    <form id="form1" name="form1" method="post">
                        ...
                        <table width="100%" class="table table-hover table-bordered" >
                            <tr><td colspan="4">   <div style="color:#5A738E; float:right;">审核人：${sessionScope.person.name}</div>
...
<script>
    ...
    function  reject() {
        ...
        $.ajax({
            url: "${resPath}/toolsSevenSteps/updateSevenStep71",
            type: "post",
   ...
   function  submitData() {
       ...
       layer.confirm('确定审核通过吗？', {
           ...
           $.ajax({
               url: "${resPath}/toolsSevenSteps/updateSevenStepfivenext71",
               type: "post",
               data: $('#form1').serialize(),
               success: function (data) {
                   console.log(data);
                   window.location.href="${webPath}/toolsSevenSteps/jumpSevenStepsix/"+data.obj;
               }
           });
       }, function(){
       });
        ...
        /*$.ajax({
            url: "${resPath}/7 STEP/updateSevenStepfivenext",
            type: "post",
            data: $('#form1').serialize(),
            success: function (data) {
                console.log(data)
                window.location.href="${webPath}/7 STEP/jumpSevenStepsix/"+data.obj;
            }
        });*/
    }
