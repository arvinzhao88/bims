...
<script src="${resPath}/view/report/js/issue_info.js"></script>
<script>
    /**
     * 针对具有相同名称的元素的验证的处理
     */
...
<script type="text/javascript">
    ...
    $(function () {
        ...
        /**父菜单*/
        $("#menu_report_parent").addClass("active");
        /**父菜单*/
        $("#menu_report_forms").css('display', 'block');
        /**子菜单*/
        $("#menu_issue_list").addClass("current-page");
    })
