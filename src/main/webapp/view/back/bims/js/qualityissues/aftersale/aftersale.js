...
//路径配置
aftersale.url=ctx+"/bims/aftersale/";
aftersale.requestUrl = {
		queryList:aftersale.url+"getList"
};
	...
	},
	{
		...
		"createdCell": function (nTd, sData, oData, iRow, iCol) {
			...
			if ((oData.processStatus > '1' && oData.processStatus != '7') || oData.processStatus == 1 && oData.subSource != "1") {
				html = '<a href="#" onclick="toEqr('+ sData +')" data-target=".this-true"><i class="fa fa-edit"></i>查看</a>';
			}
			// 已关闭
