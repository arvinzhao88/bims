...
<div class="x_panel">
			...
			&nbsp;&nbsp;&nbsp;&nbsp;<button type="submit" class="btn btn-success" style="margin-bottom:-4px;" onClick="location.href='${webPath}/back/offlineAdd'"><i class="fa fa-plus-circle"></i> 新建问题</button>
			<!--工具条结束-->
			<div class="clearfix"></div>
			</div>
            ...
            <div class="x_content">
              <table width="100%" class="table table-bordered table-hover" id="datatable">
                ...
                <tbody>
                  <tr>
                    <td>181105012</td>
                    <td><a href="z_x_correct.jsp"><strong>这里是质量描述的内容用于作为</strong></a></td>
                    <td>2.8</td>
                    <td>1123</td>
                    <td>123123 / 345123</td>
                    <td>张无忌</td>
                    ...
                    <td>张晓明</td>
                    <td>---/---</td>
                    <td><font style=" color:#0099FF; font-weight:bold;">待处理</font></td>
                    <td align="center"><a href="#" data-toggle="modal" data-target=".this-true"><i class="fa fa-trash"></i></a></td>
                  </tr>
                  <tr>
                    <td>181105013</td>
                    <td><a href="z_x_correct.jsp"><strong>这里是的内容用于作的标题</strong></a></td>
                    <td>2.8</td>
                    <td>2123</td>
                    <td>123123 / 345123</td>
                    <td>王丙</td>
                  ...
                  <tr>
                    ...
                    <td>7STEP / 张三<br>
                      SCAR / 李冰<br>
                      Notification</td>
                    <td><font style=" color:#00CC00; font-weight:bold;">处理中</font></td>
                    <td align="center"><a href="#" data-toggle="modal" data-target=".this-true"><i class="fa fa-trash"></i></a></td>
                  </tr>
                  <tr>
                    <td>181105013</td>
                    ...
                    <td>7STEP / 张三<br>
                      SCAR / 张三</td>
                    <td><font style="color:#FF9900; font-weight:bold;">审核中</font></td>
                    <td align="center"><a href="#" data-toggle="modal" data-target=".this-true"><i class="fa fa-trash"></i></a></td>
                  </tr>
                  <tr>
                    <td>181105013</td>
                    ...
                    <td>7STEP / 张晓明<br>
                      SCAR / 李俊</td>
                    <td><font style=" color:#666666; font-weight:bold;">关闭</font></td>
                    <td align="center"><a href="#" data-toggle="modal" data-target=".this-true"><i class="fa fa-trash"></i></a></td>
                  </tr>
                </tbody>
              </table>
