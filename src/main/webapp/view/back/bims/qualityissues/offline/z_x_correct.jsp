...
<div class="x_panel">
			...
			<form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                ...
                <tr align="right">
			    <td colspan="4" style="border-top: #CCCCCC 1px dashed; height:1px;"></td>
			    </tr>
              
                <tr>
                <td align="right"><strong>检验人：</strong></td>
                <td><input type="text" id="first-name" required="required" class="form-control" value="手工输入"></td>
                <td align="right"><strong>项目：</strong></td>
                <td><input type="text" id="first-name" required="required" class="form-control" value="手工输入"></td>
                </tr>
                 <tr>
                <td align="right"><strong>是否计入RFT：</strong></td>
                <td><select class="form-control">
				<option>NO</option>
				<option>YES</option>
				</select></td>
...
<!-- 遮蔽内容开始 -->
	<div class="modal fade this-true" tabindex="-1" role="dialog" aria-hidden="true" >
		<div class="modal-dialog modal-lg" style="width:350px;padding-top:200px;">
            ...
            <button type="button" class="btn btn-primary antoclose2" data-dismiss="modal" onClick="javascrtpt:window.location.href='z_x_eqr.jsp'">确定</button>
          </div>
			</div>
		</div>
	</div>
