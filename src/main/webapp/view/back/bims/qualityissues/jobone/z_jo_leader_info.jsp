                                ...
                                <div class="form-group">
                                    ...
                                    <table width="100%" class="table table-hover table-bordered" id="datatable1">
                                        ...
                                        <tr>
                                            ...
                                            <td width="22%"><select name="select2"
                                    ...
                                    <div class="form-group">
                                        <div id="btn1" style="text-align:center; display: none">
                                            <button class="btn btn-danger" type="button" data-toggle="modal" onclick="">驳回
                                            </button>
                                        </div>
                                        <div id="btn2" style="text-align:center; display: none">
                                            <button class="btn btn-primary" type="button" data-toggle="modal" onclick="">处理完成
                                            </button>
                                        </div>
                                    </div>
                                    <!--按钮完成-->
