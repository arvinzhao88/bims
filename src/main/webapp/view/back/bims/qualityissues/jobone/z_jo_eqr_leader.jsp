...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="table table-hover table-bordered">
  ...
  <tr>
    ...
    <td width="15%"><strong>CAR/CCAR 号码</strong></td>
    <td width="15%">&nbsp;</td>
    ...
    <td width="10%">&nbsp;</td>
            ...
            <button class="btn btn-success" type="reset" data-toggle="modal" data-target=".this-open">开始处理</button>
            </div>
            </div>
            <!--按钮完成-->
				</form>
...
<!-- 遮蔽内容结束 -->
<!-- 遮蔽内容开始 -->
	<div class="modal fade this-open" tabindex="-1" role="dialog" aria-hidden="true" >
		<div class="modal-dialog modal-lg" style="width:350px;padding-top:200px;">
			<div class="modal-content">
				...
				<div class="modal-footer">
            <button type="button" class="btn btn-default antoclose2" data-dismiss="modal">取消</button>
            <button type="button" class="btn btn-primary antoclose2" data-dismiss="modal" onClick="javascrtpt:window.location.href='z_jo_leader.jsp'">确定</button>
          </div>
			</div>
		</div>
	</div>
