...
<div class="x_panel">
			...
			<h2>问题列表</h2>
				...
				<%--</ul>--%>
			<%--<!--工具条-->--%>
			<%--<label class="control-label" style="width:100px;float:left; padding:8px 0 0 30px; text-align:right;">问题状态：</label>--%>
				...
				<%--<option>关闭</option>--%>
				<%--</select>	--%>
		    <%--<label class="control-label" style="width:100px;float:left; padding:8px 0 0 30px; text-align:right;">是否搭载：</label>--%>
				<%--<select class="form-control" style="width:110px; float:left">--%>
				<%--<option>- 请选择 -</option>--%>
				<%--<option>Yes</option>--%>
				<%--<option>No</option>--%>
				<%--</select>--%>
			<%--<label class="control-label" style="width:80px;float:left; padding:8px 0 0 30px; text-align:right;">Level：</label>--%>
				<%--<select class="form-control" style="width:110px; float:left">--%>
				<%--<option>- 请选择 -</option>--%>
				<%--<option>A</option>--%>
				<%--<option>B</option>--%>
			...
			<%--&nbsp;&nbsp;&nbsp;&nbsp;<button type="submit" class="btn btn-success" style="margin-bottom:-4px;" onClick="location.href='${webPath}/back/eqaAdd'"><i class="fa fa-plus-circle"></i> 提交问题</button>--%>
			<!--工具条结束-->
				<form>
				...
				<div class="col-md-9 col-sm-9 col-xs-12 col-md-offset-3" style="margin-left: 8.4%;">
					...
					<c:if test="${fn:contains(person.belongRole, '2') or fn:contains(person.belongRole, '7')}">
						<button type="button" class="btn btn-primary" style="margin-bottom:-4px; float: right; margin-right: 1%" onClick="location.href='${webPath}/back/eqaAdd'">新建</button>
					</c:if>
            ...
            <div class="x_content">
              <table width="100%" class="table table-bordered table-hover" id="example" style="margin-bottom: 0px;border-bottom: 0px;">
                ...
                <tbody>
                  <%--<tr>
                    <td>181105012</td>
                    <td><a href="z_e_correct.jsp"><strong>这里是质量描述的内容用于作为</strong></a></td>
                    <td>123123 / 324234 </td>
                    <td>Yes</td>
                    <td>SO23423</td>
                    <td>2341432</td>
                  ...
                  <tr>
                    <td>181105013</td>
                    <td><a href="z_e_correct.jsp"><strong>这里是的内容用于作的标题</strong></a></td>
                    <td>123123 / 324234 </td>
                    <td>Yes</td>
                    <td>SO23423</td>
                    <td>2341432</td>
...
<script type="text/javascript" src="${resPath}/view/back/bims/js/qualityissues/eqa/eqa.js"></script>
<script>
	//获取下拉框
	...
	function excel() {
		...
		var no = $("#number").val();
		location.href = '${webPath}/excel/eqaExport?qualityType=' + qType + '&plant=' + plant +'&isEqr=' + eqr + '&processStatus=' + status + '&processPersonName=' + processPerson+ '&startTime=' + startTime + '&endTime=' + endTime + '&number=' + no + '&issueCategoryL1Name=' + isBacth+ '&isAll='+isAll
