...
<div class="col-md-12 col-sm-12 col-xs-12">
  ...
  <div class="x_panel" style="width:75%;float:left; margin-right:10px;">
				...
				<button class="btn" type="button" onClick="javascrtpt:window.location.href='#'">取消</button>
				<button class="btn btn-primary" type="reset" onClick="javascrtpt:window.location.href='z_a_ts456.jsp'">下一步</button>
				</div>
				</div>
				<!--按钮完成-->
				</form>
