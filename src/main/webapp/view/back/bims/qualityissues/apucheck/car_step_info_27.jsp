...
<div class="container body">
    <div class="x_panel" style="width:100%;float:left; margin-right:10px;">
        <div role="tabpanel" class="tab-pane fade active in" id="tab_content11"
            ...
            <div class="ln_solid"></div>
            <div class="form-group" id="reviewBtn">
                <div style="text-align:center">
                    <button class="btn btn-primary" type="button" <%--data-toggle="modal"
                            data-target=".this-go"--%> onclick="closeCar(${car.id},${issue.id})">同意关闭
                    </button>
    ...
    <div class="modal-dialog modal-lg" style="width:350px;padding-top:1600px;">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-default antoclose2" data-dismiss="modal">取消</button>
                <button type="button" class="btn btn-primary antoclose2" data-dismiss="modal"
                        onclick="closeCar(${car.id},${issue.id})">确定
                </button>
            </div>
        </div>
    </div>
...
<script>
    ...
    $(function () {
        var reviewStatus = ${car.reviewStatus};
        if (reviewStatus =='3') {
            $("#reviewBtn").remove();
        }
    })
    ...
    //同意关闭
    function closeCar(carId, issueId) {
        layer.confirm("确定关闭Car吗？", {
            icon: 3,
            title: "系统提示",
            offset: "75%"
        }, function () {
