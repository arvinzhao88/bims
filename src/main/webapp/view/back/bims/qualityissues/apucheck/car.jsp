                                    ...
                                    <div class="" role="tabpanel" data-example-id="togglable-tabs">
                                        ...
                                        <div id="myTabContent2" class="tab-content">
                                            <div role="tabpanel" class="tab-pane fade active in" id="tab_content11"
                                                ...
                                                <form id="demo-form2" data-parsley-validate
                                                    ...
                                                    <table width="100%" border="0" cellspacing="0" cellpadding="0"
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td width="29%"><input type="text" id="carNo" name="carNo"
                                                                                   required="required"
                                                                                   class="form-control"
                                                                                   value="${issue.number}"></td>
                                                            <td width="19%" align="right">填写日期：</td>
                                                            <td width="29%"><input type="text" id="createDate"
                                                                                   name="createDate"
                                                                                   required="required"
                                                                                   class="form-control"
                                                                                   value="<fmt:formatDate value="${issue.inputTime}" pattern="yyyy-MM-dd HH:mm:ss"/>">
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td align="right">发出者：</td>
                                                            <td><input type="text" id="sponsorName" name="sponsorName"
                                                                       required="required"
                                                                       class="form-control"
                                                                       value="${issue.inputPerson}"></td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><select name="carType" class="form-control">
                                                                <option value="">请选择</option>
                                                                <option value="CAR">CAR</option>
                                                                <option value="SCAR">SCAR</option>
                                                                <option value="7STEP">7STEP</option>
                                                                <option value="Notifiction">Notifiction</option>
                                                            </select></td>
                                                        </tr>
                                                        <tr>
                                                            <td align="right">问题标题：</td>
                                                            <td colspan="3"><input type="text" id="issueTitle"
                                                                                   name="issueTitle"
                                                                                   required="required"
                                                                                   class="form-control"
                                                                                   value="${issue.issueDesc}"></td>
                                                        </tr>
                                                        <tr>
                                                ...
                                                <div class="form-group">
                                                    <form id="demo-form4" data-parsley-validate
                                                          class="form-horizontal form-label-left">
                                                        <table width="100%" border="0" cellpadding="0" cellspacing="0"
                                                               style="border-collapse:separate;border-spacing:15px;">
                                                            <tr>
                                                                <td align="right" style="width:17%">短期措施：</td>
                                                                <td colspan="3"><input type="text" id="first-name13"
                                                                                       required="required"
                                                                                       class="form-control"
                                                                                       value="手工输入"></td>
                                                                <td align="right" width:8%><i
                                                        ...
                                                        <table width="100%" border="0" cellpadding="0" cellspacing="0"
                                                            ...
                                                            <tr>
                                                                <td align="right" style="width:17%">短期措施：</td>
                                                                <td colspan="3"><input type="text" id="first-name23"
                                                                                       required="required"
                                                                                       class="form-control"
                                                                                       value="手工输入">
                                                                </td>
                                                            ...
                                                            <tr>
                                                                <td align="right">责任人：</td>
                                                                <td><input type="text" id="first-name14"
                                                                           required="required" class="form-control"
                                                                           value="手工输入"></td>
                                                                <td align="right">执行日期：</td>
                                                                <td><input type="text" id="first-name16"
                                                                           required="required" class="form-control"
                                                                           value="手工输入"></td>
                                                                <td align="right">&nbsp;</td>
                                                            </tr>
                                                ...
                                                <div class="form-group">
                                                    <form id="demo-form5" data-parsley-validate
                                                          class="form-horizontal form-label-left">
                                                        <table width="100%" border="0" cellpadding="0" cellspacing="0"
                                                               style="border-collapse:separate;border-spacing:15px;">
                                                            <tr>
                                                ...
                                                <div class="form-group">
                                                    <form id="demo-form6" data-parsley-validate
                                                          class="form-horizontal form-label-left">
                                                        <table width="100%" border="0" cellpadding="0" cellspacing="0"
                                                               style="border-collapse:separate;border-spacing:15px;">
                                                            <tr>
                                                ...
                                                <div class="form-group">
                                                    <form id="demo-form7" data-parsley-validate
                                                          class="form-horizontal form-label-left">
                                                        <table width="100%" border="0" cellpadding="0" cellspacing="0"
                                                               style="border-collapse:separate;border-spacing:15px;">
                                                            <tr>
                                                        ...
                                                        <table width="100%" border="0" cellpadding="0" cellspacing="0"
                                                            ...
                                                            <tr>
                                                                <td align="right" style="width:17%">责任人：</td>
                                                                <td><input type="text" id="first-name17"
                                                                           required="required" class="form-control"
                                                                           value="手工输入"></td>
                                                                <td align="right">目标日期：</td>
                                                ...
                                                <div class="form-group">
                                                    <form id="demo-form8" data-parsley-validate
                                                          class="form-horizontal form-label-left">
                                                        <table width="100%" border="0" cellpadding="0" cellspacing="0"
                                                               style="border-collapse:separate;border-spacing:15px;">
                                                            <tr>
                                                ...
                                                <div class="form-group">
                                                    <form id="demo-form9" data-parsley-validate
                                                          class="form-horizontal form-label-left">
                                                        <table width="100%" border="0" cellpadding="0" cellspacing="0"
                                                               style="border-collapse:separate;border-spacing:15px;">
                                                            <tr>
                                                        ...
                                                        <table width="100%" border="0" cellpadding="0" cellspacing="0"
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td colspan="5">
                                                                    ...
                                                                    <input type="radio" class="flat" name="checkFile"  <c:if test="${fn:contains(car.checkFile, '2') }">checked="checked"</c:if>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td align="right"><input type="text" id="first-name18"
                                                                                         required="required"
                                                                                         class="form-control"
                                                                                         value="手工输入"></td>
                                                            </tr>
                                                            <tr>
                                                                ...
                                                                <td><input type="text" id="first-name19"
                                                                           required="required" class="form-control"
                                                                           value="手工输入"></td>
                                                                <td align="right">NCM QTY：</td>
                                                                <td align="right"><input type="text" id="first-name20"
                                                                                         required="required"
                                                                                         class="form-control"
                                                                                         value="手工输入"></td>
                                                            </tr>
                                                            <tr>
                                                                ...
                                                                <td colspan="5"><input type="text" id="first-name21"
                                                                                       required="required"
                                                                                       class="form-control"
                                                                                       value="手工输入"></td>
                                                            </tr>
...
<div class="modal fade this-go" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg" style="width:350px;padding-top:200px;">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-default antoclose2" data-dismiss="modal">取消</button>
                <button type="button" class="btn btn-primary antoclose2" data-dismiss="modal" onclick="submit(${issue.id})">确定</button>
            </div>
        </div>
    </div>
</div>
...
<script>
    ...
    function submit(id) {
        ...
        $.ajax({
            url: '${webPath}/bims/apucheck/isEqr',
            type: "POST",
            dataType: "json",
            data: params,
            success: function(res) {
