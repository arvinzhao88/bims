                                ...
                                <div class="" role="tabpanel" data-example-id="togglable-tabs">
                                    ...
                                    <div id="myTabContent2" class="tab-content">
                                        ...
                                        <form id="form1" name="form1" method="post">
                                            <input type="hidden" name="leadingPersonAccount" value="${leadaccount}">
                                            <input type="hidden" name="checkPersonAccount" value="${checkaccouunt}">
                                            <input type="hidden"  name="questionId" value="${issue.id}">
                                        <div role="tabpanel" class="tab-pane fade active in" id="tab_content13" aria-labelledby="home-tab">
                                            <table width="100%" class="table table-hover table-bordered" id="" style="font-size:12px;">
                                                <tr>
                                                    <td colspan="4">
                                                      ...
                                                      <%--  <div style="color:#5A738E; float:right;">责任人：</div>--%>
                                                    </td>
                                                </tr>
                                          ...
                                          <tr>
                                                 ...
                                                 <tr>
                                                 <td colspan="4">
                                                     <textarea name="stepValue" rows="2" class="form-control" id="message" required="required" data-parsley-trigger="keyup" disabled="disabled" data-parsley-minlength="20" data-parsley-maxlength="100">${sevenSteps.stepValue}</textarea>
                                                 </td>
                                                     <%--   </tr>
...
<script>
    function  submitData() {
        ...
        $.ajax({
            url: "${webPath}/SevenSteps/addsevenstep",
            type: "post",
            data: $('#form1').serialize(),
            success: function (data) {
                console.log(data)
                window.location.href="${webPath}/SevenSteps/showSevenStepById"+data.obj;
            }
        });
    }
