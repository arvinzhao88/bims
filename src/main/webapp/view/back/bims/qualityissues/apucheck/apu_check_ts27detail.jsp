                                    ...
                                    <div id="myTabContent2" class="tab-content">
                                        <div role="tabpanel" class="tab-pane fade active in" id="tab_content11"
                                                            ...
                                                            <td>
                                                                ...
                                                                <c:forEach items="${extCar}" var="ext">
                                                                    <c:if test="${ext.carStep == '2' && not empty ext.attachName}">
                                                                        <a href="${uploadUrl}${ext.attachName}" download target="_blank">下载附件</a>
                                                                    </c:if>
                                                                </c:forEach>
                                                            </td>
                                                            <td>&nbsp;</td>
                                                            ...
                                                            <td>
                                                                ...
                                                                <c:forEach items="${extCar}" var="ext">
                                                                    <c:if test="${ext.carStep == '6' && not empty ext.sixthAttach}">
                                                                        ...
                                                                        <a href="${uploadUrl}${ext.sixthAttach}" download target="_blank">下载附件</a>
                                                                    </c:if>
                                                                </c:forEach>
                                                            </td>
                                                        </tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <c:forEach items="${extCar}" var="ext">
                                                                    <c:if test="${ext.carStep == '7' && not empty ext.reportName}">
                                                                        ...
                                                                        <a href="${uploadUrl}${ext.reportName}" download target="_blank">下载附件</a>
                                                                    </c:if>
                                                                </c:forEach>
                                                            </td>
                                                            <td align="right">&nbsp;</td>
                                            ...
                                            <div class="form-group">
                                                <div style="text-align:center">
                                                    <button class="btn" type="button"
                                                            onClick="javascrtpt:window.location.href=''">
                                                        取消
                                                    </button>
                                                    <button class="btn btn-primary" type="button" data-toggle="modal"
