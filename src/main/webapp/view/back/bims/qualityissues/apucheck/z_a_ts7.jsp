...
<div class="col-md-12 col-sm-12 col-xs-12">
  ...
  <div class="x_panel" style="width:75%;float:left; margin-right:10px;">
				...
				<div class="form-group">
                    <div class="" role="tabpanel" data-example-id="togglable-tabs">
						...
						Monitor.Prevent Recurrence.监控，预防再发生。（RCA）
							 ...
							 <h2>关联附件</h2>
						     <i class="fa fa-file-archive-o" style="font-size:34px;"></i>&nbsp;&nbsp;&nbsp;&nbsp;
							 <button class="btn" type="reset" data-toggle="modal" style=" margin-bottom:18px;">上传附件</button>
				...
				<button class="btn" type="button" onClick="javascrtpt:window.location.href='z_a_ts7.jsp'">上一步</button>
				<button class="btn btn-primary" type="reset" data-toggle="modal" data-target=".this-true">提交审核</button>
				</div>
				</div>
				<!--按钮完成-->
				</form>
	...
	<div class="modal fade this-true" tabindex="-1" role="dialog" aria-hidden="true" >
		<div class="modal-dialog modal-lg" style="width:350px;padding-top:200px;">
			<div class="modal-content">
				...
				<p>提交审核后将不能再次修改，确定提交吗?</p>
				</div>
				<div class="modal-footer">
            <button type="button" class="btn btn-default antoclose2" data-dismiss="modal">取消</button>
            <button type="button" class="btn btn-primary antoclose2" data-dismiss="modal" onClick="javascrtpt:window.location.href='z_a_ts.jsp'" >确定</button>
          </div>
			</div>
		</div>
	</div>
