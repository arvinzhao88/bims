                ...
                <div class="form-group">
                    <table width="100%" border="0" cellpadding="0" cellspacing="0"
                        ...
                        <tr>
                            ...
                            <td colspan="5">
                                <input disabled type="radio" class="flat" name="improve"  <c:if test="${car.improve eq 'ER' }">checked</c:if>
                                       id="ER" value="ER" checked="" required/>&nbsp;ER&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                <input disabled type="radio" class="flat" name="improve"  <c:if test="${car.improve eq 'MCR' }">checked</c:if>
                                       id="MCR" value="MCR"/>&nbsp;MCR&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                <input disabled type="radio" class="flat" name="improve"  <c:if test="${car.improve eq 'SCR' }">checked</c:if>
