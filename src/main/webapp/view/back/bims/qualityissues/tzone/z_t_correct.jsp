            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        <div class="x_title">
                            <h2>修正问题 <font
                                    style="color:#FF0000; font-size:14px; margin-left:50px; margin-bottom:-10px;"></font>
                            </h2>
                            ...
                            <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                                <table width="100%" border="0" cellspacing="0" cellpadding="0"
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="text" id="palNo" name="palNo" value="${issueExtend.palNo}" onblur="check(this)"
                                                    class="form-control col-md-7" value=""></td>
                                        <td align="right"><strong>Tray No./托盘号： </strong></td>
                                        <td><input type="text" id="trayNo" name="trayNo" value="${issueExtend.trayNo}" onblur="check(this)"
                                                    class="form-control col-md-7" value=""></td>
                                    </tr>
                                    <tr>
                                        <td align="right"><strong>Issue Category L1&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br>问题类型Level1： <font color='red'>*</font></strong></td>
                                        <td><select id="issueCategoryL1" name="issueCategoryL1" class="form-control" required>
                                        ...
                                        <td><select id="issueCategoryL2" name="issueCategoryL2" class="form-control" required>
                                    ...
                                    <%--<tr>
                                        <td align="right"><strong>Series No./序列号（追溯号）： <font color='red'>*</font></strong></td>
                                        <td>--%>
                                            <input type="hidden" id="seriesNo" name="seriesNo"
                                                   class="form-control" value="${issue.seriesNo}" required>
                                      <%--  </td>
                                    </tr>--%>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="3" align="left">
                                            <textarea name="comments" id="comments" cols="500" rows="3"
                                                      class="form-control" placeholder="请输入备注">${issue.comments}</textarea></td>
                                ...
                                <div class="form-group">
                                    <div style="text-align:center">
                                        <%--<button class="btn btn-primary" type="button" data-toggle="modal"
                                                data-target=".this-send">修正，并发送处理意见
                                        </button>&nbsp;&nbsp;&nbsp;&nbsp;--%>
                                        <button class="btn btn-primary" type="button" onclick="checkNull();">确认
                                        </button>&nbsp;&nbsp;&nbsp;
                                            <button class="btn btn-default" type="button" data-toggle="modal"
                                                    data-target=".this-close"
