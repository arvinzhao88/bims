...
<head>
    ...
    <link rel="icon" href="${resPath}/view/static/images/favicon.ico"
          type="image/ico"/>
    <link rel="stylesheet" type="text/css" href="${resPath}/view/static/layer/skin/layer.css?llll"/>
    <title>${sysName}</title>
                    ...
                    <div class="x_panel">
                        <div class="x_title">
                            ...
                            <div class="col-md-9 col-sm-9 col-xs-12 col-md-offset-3" style="margin-left: 8.4%;">
                                <button id="query" class="btn btn-primary" onclick="dataTablesInit(tzone)">查询</button>
                            ...
                            <select name="select" class="form-control" style="width:110px; float:left">
                                <option>- 请选择 -</option>
                                <option>2.8</option>
                                <option>3.8</option>
                                <option>4.5</option>
                            ...
                            <c:if test="${fn:contains(person.belongRole, '2') or fn:contains(person.belongRole, '7')}">
                                <button type="submit" class="btn btn-primary"
                                        ...
                                        onClick="location.href='${webPath}/back/tzoneAdd'">新建
                                </button>
                            </c:if>
                        ...
                        <div class="x_content">
                            <table width="100%" class="table table-bordered table-hover" id="example"
                                ...
                                <%--<tr>
                                  <td>181105012</td>
                                  <td><a href="z_t_correct.jsp"><strong>这里是问题描述的内容</strong></a></td>
                                  <td>76061052 / SO12102</td>
                                  <td>23</td>
                                  <td>15</td>
                                  <td>一级问题内容 </td>
                                  <td>零部件质量问题 Part issue</td>
                                  <td>---/---</td>
                                ...
                                <tr>
                                  ...
                                  <td>一级问题内容 </td>
                                  <td>零部件质量问题 Part issue</td>
                                  <td>（<font color="#FF0000">驳回</font>）张晓明</td>
                                  <td><a href="#" data-toggle="modal" data-target=".this-time"><i class="fa fa-clock-o"></i></a> <font style=" color:#0099FF; font-weight:bold;">待处理</font></td>
                                  <td><a href="#" data-toggle="modal" data-target=".this-true"><i class="fa fa-trash"></i> 删除</a></td>
                                </tr>
                                <tr>
                            ...
                            <%--<table width="100%" border="0" cellspacing="0" cellpadding="0" class="table table-bordered" style="background-color:#FFFF99">
                              ...
                              <tr>
                                <td>区域质量工程师MFG(后台)</td>
                                <td>反馈处理意见给制造、修正手机提交、是否EQR、打开处理工具并指定责任人</td>
...
<script type="text/javascript">
    ...
    function excel() {
        ...
        var no = $("#number").val();
        location.href = '${webPath}/excel/tExport?qualityType=' + qType + '&plant=' + plant +'&isEqr=' + eqr + '&processStatus=' + status + '&processPersonName=' + processPerson+ '&startTime=' + startTime + '&endTime=' + endTime + '&number=' + no + '&issueCategoryL1Name=' + isBacth

    }
</script>
<script type="text/javascript" src="${resPath}/view/back/bims/js/qualityissues/tzone/tzone.js"></script>
</body>
</html>
