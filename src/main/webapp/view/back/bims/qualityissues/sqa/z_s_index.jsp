                    ...
                    <div class="x_panel">
                        <div class="x_title">
                            ...
                            <%--<label class="control-label"--%>
                                   <%--style="width:100px;float:left; padding:8px 0 0 30px; text-align:right;">处理状态：</label>--%>
                            ...
                            <%--</select>--%>
                            <%--<label class="control-label"--%>
                                   <%--style="width:100px;float:left; padding:8px 0 0 30px; text-align:right">Line：</label>--%>
                            <%--<select class="form-control" style="width:110px; float:left">--%>
                                <%--<option>- 请选择 -</option>--%>
                                <%--<option>2.8</option>--%>
                                <%--<option>3.8</option>--%>
                        ...
                        <%--</button>--%>
                            <%--&lt;%&ndash;&nbsp;&nbsp;&nbsp;&nbsp;<button type="submit" class="btn btn-primary"&ndash;%&gt;--%>
                                                            <%--&lt;%&ndash;style="margin-bottom:-4px;"><i class="fa fa-download"></i>&ndash;%&gt;--%>
                            <%--&lt;%&ndash;导入&ndash;%&gt;--%>
                        <%--&lt;%&ndash;</button>&ndash;%&gt;--%>
                            <%--&lt;%&ndash;&nbsp;&nbsp;&nbsp;&nbsp;<button type="submit" class="btn btn-primary"&ndash;%&gt;--%>
                                                            <%--&lt;%&ndash;style="margin-bottom:-4px;"><i class="fa fa-upload"></i> 导出&ndash;%&gt;--%>
                        <%--&lt;%&ndash;</button>&ndash;%&gt;--%>
                            <%--&nbsp;&nbsp;&nbsp;&nbsp;<button type="submit" class="btn btn-success"--%>
                                                            <%--style="margin-bottom:-4px;"--%>
                                                            <%--onClick="location.href='${webPath}/back/sqaAdd'"><i--%>
                                <%--class="fa fa-plus-circle"></i> 提交问题--%>
                        <%--</button>--%>
                            <!--工具条结束-->
                        <form>
                            ...
                            <c:if test="${fn:contains(person.belongRole, '2') or fn:contains(person.belongRole, '7')}">
                                <button type="button" class="btn btn-primary" style="margin-bottom:-4px; float: right; margin-right: 1%" onClick="location.href='${webPath}/back/sqaAdd'">新建</button>
                            </c:if>
                        ...
                        <div class="x_content">
                            <table width="100%" class="table table-bordered table-hover" id="example"
                                ...
                                <%--<tr>
                                  <td>181105012</td>
                                  <td><a href="z_s_correct.jsp"><strong>这里是质量描述的内容用于作为</strong></a></td>
                                  <td>2.8</td>
                                  <td>5634567</td>
                                  <td>湖南机械制造有限公司</td>
                                  <td>2</td>
                                ...
                                <tr>
                                  <td>181105013</td>
                                  <td><a href="z_s_correct.jsp"><strong>这里是的内容用于作的标题</strong></a></td>
                                  <td>2.8</td>
                                  <td>5634567</td>
                                  <td>湖南机械制造有限公司</td>
                                  <td>3</td>
...
<script type="text/javascript" src="${resPath}/view/back/bims/js/qualityissues/sqa/sqa.js"></script>
<script>
    //获取下拉框
    ...
    function excel() {
        ...
        var no = $("#number").val();
        location.href = '${webPath}/excel/sqaExport?qualityType=' + qType + '&plant=' + plant +'&isEqr=' + eqr + '&processStatus=' + status + '&processPersonName=' + processPerson+ '&startTime=' + startTime + '&endTime=' + endTime + '&number=' + no + '&issueCategoryL1Name=' + isBacth+ '&isAll='+isAll
